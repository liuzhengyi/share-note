...
// the following functions are added by gipsa at 2012-06-01
function get_sess_uauth()
{
	return get_session('user_auth');
}
function set_sess_uauth($v)
{
	set_session('user_auth', $v);
}
function get_sess_ucont()
{
	return get_session('user_cont');
}
function set_sess_ucont($v)
{
	set_session('user_cont', $v);
}

function get_sess_email()
{
	return get_session('user_email');
}
function set_sess_email($v)
{
